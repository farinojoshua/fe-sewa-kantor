...
export default function BookOffice() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setFormData((prev) => ({
          ...prev,
          office_space_id: officeSpaceId.toString(),
          totalAmountWithUniqueCode: grandTotal, // Update this too if it's used in form data
        }));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault(); // Ini menghentikan form dari submit default
    ...
    setIsLoading(true); // Mengubah tombol menjadi "Loading..."
